                ...
                <li class="no-padding">
                    <div class="logo-side center blue-grey darken-3">
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            if (!empty($data['nama'])) {
                                echo '<h5 class="teknokrat-side">' . $data['nama'] . '</h5>';
                            } else {
                                echo '<h5 class="teknokrat-side">Universitas Teknokrat Indonesia</h5>';
                            }
                            if (!empty($data['alamat'])) {
                                echo '<p class="description-side">' . $data['alamat'] . '</p>';
                            } else {
                                echo '<p class="description-side">Jl. Zainal Abidin Pagaralam, No.9-11 Labuhan Ratu, Kota Bandar Lampung Provinsi Lampung, 35132
                                (0721) 702022</p>';
                            }
                        }
                        ?>
