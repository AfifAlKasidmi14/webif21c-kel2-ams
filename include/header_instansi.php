                    ...
                    <div class="card blue-grey white-text">
                        <div class="card-content">';
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="ins">Universitas Teknokrat Indonesia</h5>';
                            }

                            if(!empty($data['alamat'])){
                                echo '<p class="almt">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="almt">Jl. Zainal Abidin Pagaralam, No.9-11 Labuhan Ratu, Kota Bandar Lampung Provinsi Lampung, 35132
                                (0721) 702022</p>';
                            }
                            echo '
                        </div>
