...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Jun 2023 pada 18.21
...
INSERT INTO `tbl_instansi` (`id_instansi`, `institusi`, `nama`, `status`, `alamat`, `kaprodi`, `nip`, `website`, `email`, `logo`, `id_user`) VALUES
(1, 'Universitas Teknokrat Indonesia', 'Universitas Teknokrat Indonesia', 'Terakreditasi A', 'Jl. Zainal Abidin Pagaralam, No.9-11 Labuhan Ratu, Kota Bandar Lampung Provinsi Lampung, 35132\r\n(0721) 702022 ', 'Dyah Ayu Megawati', '', 'https://teknokrat.ac.id/', 'uti@teknokrat.ac.id', 'logo.png', 1);
...
(1, 1, '001', 'Bandar Lampung', 'Tes', '02', '123', '2023-06-19', '2023-06-19', '587-Roundown Acara Academic Expo Hari 1 &  Hari 2 (Kasar).docx', 'Tes Surat Masuk', 1);
...
(1, 'kelompok_2', '827ccb0eea8a706c4c34a16891f84e7b', 'triyana', '-', 1);
